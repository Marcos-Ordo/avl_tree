...
test05_whenDeleting_CheckDoubleRotations =
    do check "DEL 4 (INS [3,4,1,2]) (LR)" (ins [3,4,1,2])
       check "DEL 1 (INS [3,4,1,2]) (RL)" (ins [3,4,1,2])

test06_whenDeletingExtras :: IO ()
test06_whenDeletingExtras =
    do check "DEL 1  (INS [1..5])"                    (ins [1..5])
       check "DEL 4  (INS [5,4..1])"                  (ins [5,4..1])
       check "DEL 3  (INS [5,2,4,1,3])"               (ins [5,2,4,1,3])
       check "DEL 33 (INS [10,15,5,33,7,12,20,11,4])" (ins [10,15,5,33,7,12,20,11,4])
